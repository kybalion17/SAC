...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Cola'), ['action' => 'edit', $cola->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Cola'), ['action' => 'delete', $cola->id], ['confirm' => __('Are you sure you want to delete # {0}?', $cola->id)]) ?> </li>
...
<div class="colas view large-9 medium-8 columns content">
    <h3><?= h($cola->id) ?></h3>
    <table class="vertical-table">
        ...
        <tr>
            <th scope="row"><?= __('Tiempo Duracion Min') ?></th>
    ...
    <div class="related">
        ...
        <?php if (!empty($cola->cliente_relationship)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($cola->cliente_relationship as $clienteRelationship): ?>
            <tr>
    ...
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($cola->vw_detalle as $vwDetalle): ?>
            <tr>
