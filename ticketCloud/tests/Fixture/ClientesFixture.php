...
class ClientesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'dni' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'idx' => ['type' => 'index', 'columns' => ['dni', 'nombre', 'id'], 'length' => []],
        ],
        '_constraints' => [
